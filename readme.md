...
A catalog of public biological imaging datasets, with some omics and expression resources, in `sources.json`. I tried to list all the datasets (or dataset-containing databases) that I know of. It is mostly focused on imaging data, but some omics adjacent data may abode in there.
